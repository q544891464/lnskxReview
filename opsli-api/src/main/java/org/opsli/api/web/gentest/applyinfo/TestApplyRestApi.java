...
import org.opsli.api.wrapper.gentest.applyinfo.TestApplyModel;
 ...
 */
public interface TestApplyRestApi {

    /** 标题 */
    String TITLE = "申请表测试";
    /** 子标题 */
    String SUB_TITLE = "申请表测试";
    ...
    */
    @GetMapping("/get")
    ResultVo<TestApplyModel> get(TestApplyModel model);
    ...
    */
    @PostMapping("/insert")
    ResultVo<?> insert(@RequestBody TestApplyModel model);
    ...
    */
    @PostMapping("/update")
    ResultVo<?> update(@RequestBody TestApplyModel model);
